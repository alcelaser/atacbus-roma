...
final syncProgressProvider = StreamProvider.autoDispose<SyncProgress>((ref) {
  ...
  return syncRepo.syncGtfsData().map((progress) {
    // When sync completes, clear in-memory caches so providers
    // pick up the fresh data from the new database contents.
